...
class CarlaSpectatorCamera(object):
    ...
    def __init__(self):
        ...
        self.camera_resolution_x = rospy.get_param("~resolution_x", 640)
        self.camera_resolution_y = rospy.get_param("~resolution_y", 480)
        self.camera_fov = rospy.get_param("~fov", 90)
