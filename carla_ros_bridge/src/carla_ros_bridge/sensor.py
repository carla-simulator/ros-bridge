    ...
    def _callback_sensor_data(self, carla_sensor_data):
        ...
        if not rospy.is_shutdown():
            if self.synchronous_mode:
                ...
                self.publish_transform(self.get_ros_transform(trans.carla_transform_to_ros_transform(carla_sensor_data.transform)))
        ...
        while True:
            try:
                ...
                self.publish_transform(
                    self.get_ros_transform(trans.carla_transform_to_ros_transform(carla_sensor_data.transform)))
                self.sensor_data_updated(carla_sensor_data)
            except queue.Empty:
                return
