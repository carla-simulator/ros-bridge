...
class RosVehicleControl(BasicControl):
    ...
    def __init__(self, actor, args=None):
        ...
        if "launch" in args and "launch-package" in args:
            ...
            rospy.loginfo("{}: Launching {} from package {}...".format(
                self._role_name, args["launch"], args["launch-package"]))
            cli_args = [args["launch-package"], args["launch"],
                        'role_name:={}'.format(self._role_name)]
