...
import carla_ros_bridge.pid_controller_physics as phys
...
class PidController(object):
    ...
    def __init__(self):
        ...
        """
        self.vehicle_state = EgoVehicleState()
        ...
        self.reconfigure_server = Server(
            ...
            namespace="/carla/ego_vehicle",
            callback=(lambda config, level: PidController.reconfigure_pid_parameters(
                self, config, level)))
    ...
    def vehicle_info_updated(self, vehicle_info):
        ...
        self.info.restrictions.max_decel = phys.get_vehicle_max_deceleration(
            self.vehicle_info)
        self.info.restrictions.min_accel = 0.0
    ...
    def run(self):
        ...
        Calculates and sends the new values for VehicleControl()
...
def main():
    ...
    :return:
    """
    rospy.init_node('ackermann_to_carla_control')
